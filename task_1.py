...
class Huffman(object):
    ...
    def binary_tree(self):
        res_tree = Huffman.getting_frequencies(self)
    ...
    def huffman_coding(self, tree, path=''):
        if not isinstance(tree, dict):
            ...
            Huffman.huffman_coding(self, tree[0], path=f'{path}0')
            Huffman.huffman_coding(self, tree[1], path=f'{path}1')
...
if __name__ == "__main__":
    ...
    my_code = HC.huffman_coding(my_tree)
